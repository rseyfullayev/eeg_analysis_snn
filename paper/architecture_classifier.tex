% =============================================================================
%  Contrastive Encoder Architecture Diagram
...
\node[stglbl] at (s3-top) [above=6pt] {Stage 3};
\node[stglbl] at (s4-top) [above=8pt] {Stage 4};
...
$(T,B,C,H,W) \to (B,C,T,H,W) \xrightarrow{\text{GN}} 
(B,C,T,H,W) \to (T,B,C,H,W)$
\qquad Permutes for 3D normalization; used for GroupNorm($n_g=1$) \& Dropout3d.\\[4pt]
...
\node[font=\tiny\sffamily, text=black!50, anchor=west, text width=15cm] at (-0.3, -0.2) 
  {All feature maps carry shape $(T, B, C, H, W)$ with $T{=}32$ timesteps. 
   ...
   normalized via TemporalOrderFix(GroupNorm($n_g=1$)), and collapsed by temporal mean pooling in the ProjectionHead.
